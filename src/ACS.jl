...
export dataset, plot, plot!, scatter, scatter!, xlabel!, ylabel!, title!, eigvals, eigvecs, transpose, svd, diagm,
pinv, diag, xlims!, ylims!, describe, mean, median, bar, bar!, diagind, hclust, sp, pairwise, kmeans, assignments, annotate!, histogram,
histogram!, Normal, Gamma, fit_mle, std, pdf, cdf, read_ACS_data, sample, CSV, DataFrame, cov, cor, Diagonal, I, inv, 
